...
[高级悬架工程手册](advanced/README.md) 已接入站点导航。它按章节覆盖设计目标、轮胎、几何硬点、弹簧阻尼、仿真优化、金属结构、复合材料、验证答辩、软件工作流和评审清单。读者不需要接触本地历史源文件；公开依据请看每章公开来源和 [参考资料](references.md)，正文沿着工程问题、输入输出和验证方法往下读。
