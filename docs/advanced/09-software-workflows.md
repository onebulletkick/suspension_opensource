...
| 几何与包络 | AutoCAD、CATIA / 3D CAD | 轮胎 / 轮辋、车架、制动、转向、车身、目标几何 | 硬点草图、三维装配包络、干涉和接口清单 | Adams Car、结构支座、制造计划 | 2D 草图被当成 3D 干涉证明 |
...
| 导力与结构 | Adams View、Abaqus / Ansys、MATLAB / Python | 轮载、接地点力、连接定义、柔性体、材料和边界 | 连接点载荷、FEA boundary package、结构修改建议 | 金属件、复材件、测试前检查 | 最大力没有方向、坐标和事件说明 |
| 实车回流 | Race Studio / AIM、MATLAB / Python、Git / Markdown | 通道字典、传感器标定、测试日志、车辆版本 | 数据清洗、仿真-实车差异、模型修正和复测计划 | 轮胎模型、参数表、载荷工况、答辩证据 | 只保留结果图，不保留数据处理方法 |
